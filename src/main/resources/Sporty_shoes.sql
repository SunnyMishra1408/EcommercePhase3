...
reportPrice int(20));
insert into purchase_report values(1,"Strickrer","sunnymishra1408@gmail.com","14-08-1998",399);
...
insert into user values(1,"Sunny","sunnymishra@gmail.com",24,"Male","D Honnur");
select * from user;
